RSpec.describe Order, type: :model do
  ...
  describe "#build_placements_with_ids_and_quantities" do
    before(:each) do
  ...
  describe "#valid?" do
    before do
      ...
      placement_1 = FactoryGirl.build :placement, product: product_1,
                                                  quantity: 3
      placement_2 = FactoryGirl.build :placement, product: product_2,
                                                  quantity: 15
      @order = FactoryGirl.build(:order)
